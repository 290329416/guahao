...
/**
 * Chrome    Mozilla/5.0 (Macintosh; Intel Mac OS X 10_8_4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/29.0.1531.0 Safari/537.36
...
class CURL
{
    ...
    {
        $browsers = $this->spider();
 //       $browsers = array(
//            'X-FORWARDED-FOR:115.151.1.10',
//            'CLIENT-IP:115.151.1.10'
//        );
        $header = [
        ...
        $header=[];
        $header=array_merge($browsers,$header);
        //模拟百度蜘蛛
        ...
        $opt[CURLOPT_REFERER] = 'http://' . parse_url($url, PHP_URL_HOST);
    ...
    {
        $browsers[] = array(
            'X-FORWARDED-FOR:220.181.68.134',
            'CLIENT-IP:220.181.68.134'
        );
        $browsers[] = array(
            'X-FORWARDED-FOR:220.181.7.116',
            'CLIENT-IP:220.181.7.116'
        );
        $browsers[] = array(
            'X-FORWARDED-FOR:220.181.50.210',
            'CLIENT-IP:220.181.50.210'
        );
        $browsers[] = array(
            'X-FORWARDED-FOR:123.125.71.95',
            'CLIENT-IP:123.125.71.95'
        );
        $browsers[] = array(
            'X-FORWARDED-FOR:123.125.66.130',
            'CLIENT-IP:123.125.66.130'
        );
        $browsers[] = array(
            'X-FORWARDED-FOR:220.181.7.134',
            'CLIENT-IP:220.181.134'
        );
        $browsers[] = array(
            'X-FORWARDED-FOR:123.125.66.212',
            'CLIENT-IP:123.125.66.212'
        );
        $browsers[] = array(
            'X-FORWARDED-FOR:220.181.51.144',
            'CLIENT-IP:220.181.51.144'
        );
        $browsers[] = array(
            'X-FORWARDED-FOR:123.125.71.117',
            'CLIENT-IP:123.125.71.117'
        );
        return $browsers[array_rand($browsers, 1)];
    }
}