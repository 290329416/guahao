...
class UserModel extends AdminModel {
    ...
    public function changePassword($userid, $newPassword) {
        ...
        return $this->db->update('admin', ['password' => $newPassword, 'updatedate' => $_SERVER['time']], ['id' => intval($userid)]);
    }
    ...
    public function update_admin_user($data, $userid) {
        return $this->db->update('admin', $data, ['id' => $userid]);
    }
    ...
    public function delete_admin_user($userid) {
        return $this->db->delete('admin', ['id' => $userid]);
    }
    ...
    public function disable_admin_user($userid) {
        return $this->db->update('admin', ['status' => 0], ['id' => $userid]);
    }
    ...
    public function enable_admin_user($userid) {
        return $this->db->update('admin', ['status' => 1], ['id' => $userid]);
    }
