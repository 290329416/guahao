<?php if(!defined('APP_PATH')) exit('No direct script access allowed');
	...
	class ModelfieldsModel extends AdminModel
	{
		...
		public function add_model_fields($data){
			return $this->db->insert('model_field',$data);
		}
		...
		public function edit_model_fields($data,$fieldsid){
			return $this->db->update('model_field',$data,['fieldid'=>$fieldsid]);
		}
		...
		public function delete_model_fields($fieldsid){
			return $this->db->delete('model_field',['fieldid'=>$fieldsid]);
		}
		...
		public function enable_model_fields($fieldsid){
			return $this->db->update('model_field',['status'=>1,'update_time'=>$_SERVER['time']],['fieldid'=>$fieldsid]);
		}
		...
		public function disable_model_fields($fieldsid){
			return $this->db->update('model_field',['status'=>0,'update_time'=>$_SERVER['time']],['fieldid'=>$fieldsid]);
		}
